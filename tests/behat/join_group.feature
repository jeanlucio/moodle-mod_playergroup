...
Feature: Student joins an existing open group
  ...
  Background:
    ...
    And I am on the "Taverna do Curso" "mod_playergroup > view" page logged in as "student1"
  ...
  Scenario: Second student joins the open group and sees the My Group badge
    Given I am on the "Taverna do Curso" "mod_playergroup > view" page logged in as "student2"
    And I should see "Dragões do Norte"
