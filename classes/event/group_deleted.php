...
/**
 * Event fired when an empty group is automatically deleted.
 *
...
class group_deleted extends \core\event\base {
    ...
    public static function get_name(): string {
        return get_string('event_group_deleted', 'mod_playergroup');
    }
    ...
    public function get_description(): string {
        return "The empty group with id '$this->objectid' was automatically deleted " .
